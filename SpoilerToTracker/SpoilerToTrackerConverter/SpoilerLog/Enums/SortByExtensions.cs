    ...
    public static class SortByExtensions
    {
        public static string CustomToString(this SortBy sortBy)
        {
            return sortBy switch
            {
                ...
                SortBy.JunkLocationsAlphabetic => "A-Z",
                SortBy.PreCompleteDungeonsAlphabetic => "A-Z",
                SortBy.PreCompleteDungeonsTrackerOrder => "Tracker Order",
                ...
                SortBy.PlandoLocation => "Location A-Z",
                SortBy.PlandoItem => "Item A-Z",
                SortBy.PathsPath => "Path A-Z",
                SortBy.PathsLocation => "Location A-Z",
                SortBy.PathsItem => "Item A-Z",
